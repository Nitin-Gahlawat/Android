...
import com.example.audiofetch.databinding.ActivityPlayingSongBinding
...
class PlayingSong : AppCompatActivity() {
    ...
    private val binding: ActivityPlayingSongBinding by lazy {
        ActivityPlayingSongBinding.inflate(layoutInflater)
    }
    private lateinit var mediaUrl: File
    ...
    private val seekForward: Long = 10000
    private val seekBackward: Long = 10000
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mediaUrl = File(intent.getStringExtra("SongUri").toString())
    ...
    private fun pauseMedia() {
        binding.btnPlayPause.setImageDrawable(AppCompatResources.getDrawable(this, R.drawable.play))
        controller.pause()
    }
